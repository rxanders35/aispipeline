...
This is an experimental attempt to create an ETL (Extract, Transform, Load) pipeline using Rust and Ballista for blazingly fast distributed data processing.
